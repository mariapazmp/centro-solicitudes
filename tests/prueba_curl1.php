...
class redmine {
	...
	private function runRequest($restUrl, $method = 'GET', $data = ""){
		...
		try {
			...
			curl_setopt($this->curl, CURLOPT_HTTPHEADER, array("Content-Type: application/xml", "Content-length: ".strlen($data))); 
...
$config['url'] = "http://localhost:8081/redmine";
$config['apikey'] = '94ca89b9a388a380b08fb5170574b969f9f9e406';
$_redmine = new redmine($config);
 


$addedIssueDetails = $_redmine->addIssue('Titel', 'Body', 'reunion-periodica', 1, $userId, $open_date, $priority);
